...
<body>
    ...
    <p style='font-size:10px;'><b>Note:</b>	<br>				
        ...
        8. Payment/s made after <u>{{date('F d, Y',strtotime($soa_payment->date_due))}}</u> will be reflected on the next month billing statement.		<br>				
        <b>REMINDER: Advance Payment for 1 year will be given 1 (One) month free of Association Dues.					<br>	
            *If there are still un-posted payment comparative with your record, please let us know so that we can make the necessary adjustments.</b></p>	
        </body>
        </html>
