<div class="modal fade" id="live_payor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class='row w-100'>
                    <div class='col-10'>
                        <h1 class="modal-title" id="exampleModalLabel">Active Payor</h1>
                    </div>
                    <div class='col-2'>
            ...
            <div class="modal-body"> 
                ...
                <table id="example"  class="table align-items-center table-flush">
                    ...
                    <tbody>
                            @foreach($live_payor_datas as $live_payor_data)
                            <tr>
