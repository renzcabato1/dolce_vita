...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <span>
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" >Disbursement</a>
                <button data-toggle="modal" data-target="#new_disbursement" data-toggle="new_disbursement"  type="button" style='margin:5px;' class="btn btn-success"><i class="ni ni-fat-add"></i>Add Disbursement</button>
